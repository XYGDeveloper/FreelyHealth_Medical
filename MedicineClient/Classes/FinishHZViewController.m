...
@interface FinishHZViewController ()<ApiRequestDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation FinishHZViewController
...
- (void)viewDidLoad {
    ...
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(toReadArrebook)];
...
- (void)toReadArrebook{
    scanAgreebookViewController *scan = [scanAgreebookViewController new];
    scan.title = @"会诊意见书";
    scan.huizhenid = self.model.id;
