...
#import "LTUITools.h"
@interface PhotoCerImageView()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SDPhotoBrowserDelegate>
...
@implementation PhotoCerImageView
...
- (void)cellDataWithImageArray:(NSArray *)imageArray
{
    ...
    if (imageArray.count == 1) {
        ...
        int columnCount = ceilf(self.images.count * 1.0 / 2);
