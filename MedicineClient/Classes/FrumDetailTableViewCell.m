...
@interface FrumDetailTableViewCell()
///** <#des#> */
...
@implementation FrumDetailTableViewCell
...
- (UIImageView *)nameIcon
{
    ...
    if (!_nameIcon) {
        ...
        _nameIcon = [LTUITools lt_creatImageView];
...
- (void)setConstant
{
    ...
    [self.nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.nameIcon.mas_right).mas_equalTo(6);
