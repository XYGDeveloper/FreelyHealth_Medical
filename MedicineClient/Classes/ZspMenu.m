...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        _detailTextFont = FontNameAndSize(13);
        ...
        _rightTableView.backgroundColor = DefaultBackgroundColor;
...
- (CAShapeLayer *)createIndicatorWithPosition:(CGPoint)position color:(UIColor *)color {
    ...
    layer.lineWidth = 1.0;
    layer.strokeColor = DefaultGrayTextClor.CGColor;
...
- (CAShapeLayer *)createSeparatorWithPosition:(CGPoint)position color:(UIColor *)color {
    ...
    [path addLineToPoint:CGPointMake(160, 35)];
