...
@interface WailtHandleViewController ()<ApiRequestDelegate,UITableViewDelegate,UITableViewDataSource,RCIMGroupInfoDataSource,RCIMGroupMemberDataSource,RCIMGroupUserInfoDataSource,RCIMUserInfoDataSource>
...
@implementation WailtHandleViewController
...
- (void)api:(BaseApi *)api successWithCommand:(ApiCommand *)command responseObject:(id)responsObject{
    ...
    if (api == _joinApi) {
        ...
        self.flag = YES;
        [self refreshDetailWith:self.huizhenid issystemid:self.model.issystem];
    }
    if (api == _notjoinApi) {
...
- (void)refreshDetailWith:(NSString *)huizhenid
