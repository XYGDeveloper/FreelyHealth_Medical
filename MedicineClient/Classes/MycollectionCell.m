...
@property (nonatomic,strong) MyCollectionModel * comodel;

@property (nonatomic,strong) MyAuswerModel * ausmodel;
...
- (void)setupUI
{
    ...
    self.lineView .backgroundColor = DefaultBackgroundColor;
...
#pragma mark - friendCircleImageView每部已经自动自动计算高度
    ...
    [self.lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.timeLabel1.mas_bottom).mas_equalTo(15);
...
- (void)cellDataWithcollModel:(MyCollectionModel *)model{
    ...
    [self layoutUI:model.answer imgArr:imgArray];
