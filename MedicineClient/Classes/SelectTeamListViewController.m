//
//  SelectTeamListViewController.m
//  MedicineClient
//
...
@interface SelectTeamListViewController ()<UISearchBarDelegate,UISearchDisplayDelegate,ApiRequestDelegate>
@property (nonatomic, strong) NSArray *names;
@property (nonatomic, strong) NSArray *searchResults;
@property (nonatomic, strong) UISearchDisplayController *searchController;
@property (nonatomic,strong)SelectTeamApi *api;

@property (nonatomic,strong)SelectTeamApi *api1;
...
@implementation SelectTeamListViewController
...
- (SelectTeamApi *)api1
{
    ...
    if (!_api1) {
        ...
        _api1 = [[SelectTeamApi alloc]init];
...
- (void)addSearchBarAndSearchDisplayController {
    ...
    searchBar.placeholder = @"搜索符合条件的团队";
...
- (BOOL)searchDisplayController:(UISearchDisplayController *)controller shouldReloadTableForSearchString:(NSString *)searchString {
    ...
    [self.api1 gethosteamList:request.mj_keyValues.mutableCopy];
