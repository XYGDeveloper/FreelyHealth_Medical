...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = AppStyleColor.CGColor;
...
- (void)initControlBtn {
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f- 64.0, 100, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - 50.0f- 64.0, 100, 50)];
