...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 220)];
        ...
        [cancelButton setTitleColor:AppStyleColor forState:UIControlStateNormal];
        ...
        [chooseButton setTitleColor:AppStyleColor forState:UIControlStateNormal];
