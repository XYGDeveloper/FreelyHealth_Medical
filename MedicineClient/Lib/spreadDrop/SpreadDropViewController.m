...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"sss" style:UIBarButtonItemStylePlain target:self action:@selector(normalFromTopMenu)];
}
