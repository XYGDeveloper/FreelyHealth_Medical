...
//    }
    ...
    if (self.navigationController.viewControllers.count > 1) {
        [self setLeftNavigationItemWithImage:[UIImage imageNamed:@"back"] highligthtedImage:nil action:@selector(popButtonClicked:)];
    }
}
...
- (YQWaveButton *)setLeftNavigationItemWithTitle:(NSString *)title action:(SEL)action {
    
    YQWaveButton *button = [self navigationButtonWithTitle:title action:action];
...
- (YQWaveButton *)setLeftNavigationItemWithImage:(UIImage *)image highligthtedImage:(UIImage *)highlightedImage action:(SEL)action {
    YQWaveButton *button = [self navigationButtonWithImage:image highligthtedImage:highlightedImage action:action];
    if (@available(iOS 11.0, *)) {
        button.contentEdgeInsets = UIEdgeInsetsMake(0, -20,0, 0);
        button.imageEdgeInsets = UIEdgeInsetsMake(0, -20,0, 0);
        button.titleEdgeInsets = UIEdgeInsetsMake(0, -15,0, 0);
...
- (YQWaveButton *)setRightNavigationItemWithTitle:(NSString *)title action:(SEL)action {
...
- (YQWaveButton *)setRightNavigationItemWithImage:(UIImage *)image highligthtedImage:(UIImage *)highlightedImage action:(SEL)action {
...
- (YQWaveButton *)navigationButtonWithTitle:(NSString *)title action:(SEL)action {
    YQWaveButton *button = [YQWaveButton buttonWithType:UIButtonTypeCustom];
...
- (YQWaveButton *)navigationButtonWithImage:(UIImage *)image highligthtedImage:(UIImage *)highlightedImage action:(SEL)action {
    YQWaveButton *button = [YQWaveButton buttonWithType:UIButtonTypeCustom];
